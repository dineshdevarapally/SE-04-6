...
public class DegreePlanAddScreen extends JFrame {

    @SuppressWarnings("empty-statement")
    public DegreePlanAddScreen(final DefaultTableModel TableModel) {
        ...
        JLabel lb = new JLabel("Add Degree Plan");
        JLabel lb1 = new JLabel("Degree Code");
        JLabel lb2 = new JLabel("Discription");
        JLabel lb3 = new JLabel("Code");
        JLabel lb4 = new JLabel("Hours");
      ...
      //  JLabel lb8 = new JLabel("Elective Group 1 Courses");
       ...
       // JLabel lb10 = new JLabel("Elective Group 2 Courses");
        ...
        final JTextField txt3 = new JTextField("Code");
        final JTextField txt4 = new JTextField("Hours");
        final JTextField txt5 = new JTextField("Type");
        final JTextField txt6 = new JTextField("Courses");
