...
public class CourseUpdateScreen extends JFrame {

   public CourseUpdateScreen(final DefaultTableModel TableModel,final JTable table) {
       ...
       // DefaultListModel list = new DefaultListModel();
        ...
        JLabel lb = new JLabel("Update Course");
       ...
       // }
            ...
            /*    try { 
                ...
                */
                JOptionPane.showMessageDialog(null, "Course Updated Successfully", "Confirmation", JOptionPane.INFORMATION_MESSAGE);
                setVisible(false);
                dispose();
