...
public class ForcastAddScreen extends JFrame {

    public ForcastAddScreen(final DefaultTableModel TableModel) {
        ...
        JLabel lb = new JLabel("Add Forcast");
       ...
       // }
            ...
            /*    try { 
                ...
                */
                JOptionPane.showMessageDialog(null, "Forcast Added Successfully", "Confirmation", JOptionPane.INFORMATION_MESSAGE);
                setVisible(false);
                dispose();
