        ...
        Jb1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (!file.getName().endsWith("CSV")) {
                    ...
                    JOptionPane.showMessageDialog(null, "The Student Information file is successfully imported", "Success", JOptionPane.INFORMATION_MESSAGE);
                }
         ...
         Jb2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    ImportStudentInformationTable table=new ImportStudentInformationTable(path);
                } catch (IOException ex) {
                    Logger.getLogger(ImportStudentScreen.class.getName()).log(Level.SEVERE, null, ex);
                }
