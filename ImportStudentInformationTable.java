...
public class ImportStudentInformationTable extends JFrame{
    @SuppressWarnings("empty-statement")
    public ImportStudentInformationTable(String[] Path)throws FileNotFoundException, IOException {
         JPanel toppanel = new JPanel();
         String extension = "";
         String concat = null;
         //   ImportStudentCourses impt=new ImportStudentCourses();
         for (String ch : Path) {
             concat = extension.concat(ch);
         }
    ...
    //    Jb3.setVisible(true);
     ...
     //   Object column_names[] = {"  ", "Name", "Title", "Load", "Courses", "Days"};
         CSVReader reader=new CSVReader(new FileReader("C:\\Users\\Anish\\Documents\\NetBeansProjects\\screens\\src\\screens\\"+concat+".csv"));
