...
public class FacultyAddScreen extends JFrame {
public String FacultyName;
public String FacultyTitle;
public String FacultyLoad;
public String FacultyCourses;
public String FacultyHours;
    public FacultyAddScreen(final DefaultTableModel TableModel) {
       ...
       // DefaultListModel list = new DefaultListModel();
        ...
        JLabel lb = new JLabel("Add Faculty");
       ...
       // }
          ...
          //  list1.add(txt10.getText());
            ...
            /*    try { 
                ...
                */
                JOptionPane.showMessageDialog(null, "Faculty Added Successfully", "Confirmation", JOptionPane.INFORMATION_MESSAGE);
                setVisible(false);
                dispose();
