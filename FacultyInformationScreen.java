...
public class FacultyInformationScreen extends JFrame {

    public FacultyInformationScreen() throws FileNotFoundException, IOException {
     ...
     //   Object column_names[] = {"  ", "Name", "Title", "Load", "Courses", "Days"};
         CSVReader reader=new CSVReader(new FileReader("C:\\Users\\Anish\\Documents\\NetBeansProjects\\screens\\src\\screens\\TestDataFaculty.csv"));
       ...
       // toppanel.add(btnpanel,BorderLayout.SOUTH);
        ...
        Jb1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //setVisible(false);
                //dispose();
                FacultyAddScreen add = new FacultyAddScreen(tableModel);
            }
        });
        Jb2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               // setVisible(false);
               // dispose();
                FacultyUpdateScreen add = new FacultyUpdateScreen(tableModel,table);
            }
        });
        Jb4.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    File file = new File("C:\\Users\\Anish\\Documents\\NetBeansProjects\\screens\\src\\screens\\FacultyInformation.txt");
                    if (!file.exists()) {
                        file.createNewFile();
                    }
