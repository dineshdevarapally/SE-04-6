...
public class CourseInformationScreen extends JFrame {
    ...
    public CourseInformationScreen() throws FileNotFoundException, IOException {
     ...
     //   Object column_names[] = {"  ", "Name", "Title", "Load", "Courses", "Days"};
         CSVReader reader=new CSVReader(new FileReader("C:\\Users\\Anish\\Documents\\NetBeansProjects\\screens\\src\\screens\\TestDataCourses.csv"));
       ...
       // toppanel.add(btnpanel,BorderLayout.SOUTH);
        ...
        Jb1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               // setVisible(false);
               // dispose();
                CourseAddScreen add = new CourseAddScreen(tableModel);
            }
        });
        Jb2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              //  setVisible(false);
                //dispose();
                CourseUpdateScreen add = new CourseUpdateScreen(tableModel,table);
            }
        });
        ...
        Jb4.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae) {
                try{
        File file = new File("C:\\Users\\Anish\\Documents\\NetBeansProjects\\screens\\src\\screens\\CourseInformation.txt");
          if(!file.exists()){
              file.createNewFile();
          }
